...
export const homeFaqs: FAQ[] = [
  {
    ...
    text: [
      "Sí, puedes probar de forma totalmente gratuita la clase de kimono y sin kimono.",
    ],
  },
  {
...
export const suscribtions: FAQ[] = [
  ...
  {
    heading: "¿Cómo puedo inscribirme?",
    text: [
      "Podrás inscribirte de forma presencial en nuestro centro deportivo o de forma online comprando directamente el abono que más se ajuste a tus intereses (accede a la pestaña precios).",
    ],
  },
  {
    heading: "¿Cómo puedo cancelar mi abono?",
    text: [
...
export const classes_programs: FAQ[] = [
  {
    ...
    text: [
      "Nuestro programa de clases comienza desde los 4 años de edad. Sin embargo, contamos también con una pequeña introducción al jiujitsu de 1 día a la semana para niños de 3 años.",
    ],
  },
  {
    heading:
  ...
  {
    heading:
      "¿Puedo asistir a las clases de competición a pesar de no ser competidor?",
    text: [
      "Claro! Las clases de competición están orientadas a la preparación de las competiciones pero están abiertas a todos los alumnos. Además, el jiu jitsu es el deporte individual que más equipo necesita ya que sin compañeros de entrenamiento ninguna atleta podría prepararse y ganar medallas.",
    ],
  },
  {
