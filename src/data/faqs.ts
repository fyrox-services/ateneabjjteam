...
export const suscribtions: FAQ[] = [
  ...
  },
  {
    ...
    text: [
      "Podrás inscribirte de forma presencial en nuestro centro deportivo o de forma online comprando directamente el abono que más se ajuste a tus intereses (accede a la pestaña programas y tarifas → abonos y tarifas).",
    ],
  },
  {
